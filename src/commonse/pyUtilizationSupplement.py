...
class GeometricConstraints(object):
    ...
    def __init__(self, nPoints, diamFlag=True):
        ...
        self.weldability = np.zeros(nPoints) # self.add_output('weldability', np.zeros(nPoints))
        self.manufacturability = np.zeros(nPoints) # self.add_output('manufacturability', np.zeros(nPoints))
