...
class Material: #isotropic for the time being
    def __init__(self,**kwargs):
        ...
        prms={'name':'ASTM992_steel','E':2.1e11,'nu':0.33,'rho':8502., 'fy':345.e6, 'fyc':345.e6} #SI Units
        ...
        steel={'name':'ASTM992_steel',          'E':2.1e11,'nu':0.33,'rho':7805., 'fy':345.e6, 'fyc':345.e6,} #SI Units
        heavysteel={'name':'ASTM992_steelheavy','E':2.1e11,'nu':0.33,'rho':8741., 'fy':345.e6, 'fyc':345.e6} #SI Units
        grout={'name':'Grout',                  'E':3.9e10,'nu':0.33,'rho':2500., 'fy':20.68e6, 'fyc':20.68e6} #SI Units  TO REVISE FOR GROUT

        if ((prms['name'].lower() == 'steel') or (prms['name'].lower() == 'astm992_steel')  or (prms['name'].lower() == '')):
